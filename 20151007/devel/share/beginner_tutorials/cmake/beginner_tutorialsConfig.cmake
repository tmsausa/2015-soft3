...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/mech-user/2015-soft3/20151007/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/mech-user/2015-soft3/20151007/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/mech-user/2015-soft3/20151007/install)
...
if(NOT "/home/mech-user/2015-soft3/20151007/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/mech-user/2015-soft3/20151007/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'mech-user <mech-user@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mech-user/2015-soft3/20151007/src/beginner_tutorials/${idir}'.  Ask the maintainer 'mech-user <mech-user@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mech-user/2015-soft3/20151007/devel/lib;/home/mech-user/2015-soft3/20151007/devel/lib;/opt/ros/indigo/lib)
